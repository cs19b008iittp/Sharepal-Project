...
const CameraScreen = () => {
  ...
  const flashcardData = [
    {
      id: '1',
      title: 'Tripod and camera accessories',
      image: require('./assets/tripod_camera-accessories.png'),
      stockCount: 5,
    },
    {
      id: '2',
      title: 'DSLR Gimbal',
      image: require('./assets/dslr-gimbal.png'),
      stockCount: 10,
    },
    {
      id: '3',
      title: 'DSLR Cameras',
      image: require('./assets/dslr-cameras.png'),
      stockCount: 3,
    },
    {
      id: '4',
      title: 'BDSLR Lens',
      image: require('./assets/dslr-lens.png'),
      stockCount: 7,
    },
  ];
    ...
    <Text style={styles.mytitles}>Cameras on Rent</Text>
    </View>
    {'\n'}
      {/* Flashcards */}
