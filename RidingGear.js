  ...
  const flashcardData = [
    {
      id: '1',
      title: 'Riding Boots',
      image: require('./assets/riding-boots.png'),
      stockCount: 5,
    },
    {
      id: '2',
      title: 'Riding Essentials',
      image: require('./assets/riding-essentials.png'),
      stockCount: 10,
    },
    {
      id: '3',
      title: 'Riding Luggage',
      image: require('./assets/riding-luggage.png'),
      stockCount: 3,
    },
    {
      id: '4',
      title: 'Riding Jackets',
      image: require('./assets/riding-jackets.png'),
      stockCount: 7,
    },
  ];
    ...
    <Text style={styles.mytitles}>Riding Gear On Rent</Text>
    </View>
    {'\n'}
      {/* Flashcards */}
